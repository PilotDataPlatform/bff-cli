...
class TestListDataset(IsolatedAsyncioTestCase):
    ...
    async def test_01_list_dataset_without_token(self):
        self.log.info('\n')
        ...
        try:
            ...
            async with AsyncClient(app=self.app, base_url="http://test") as ac:
                res = await ac.get(self.test_api)
    ...
    async def test_02_list_dataset(self):
        self.log.info('\n')
    ...
    async def test_03_list_dataset_no_dataset(self):
        self.log.info('\n')
...
class TestDatasetDetail(IsolatedAsyncioTestCase):
    ...
    async def test_01_get_dataset_detail_without_token(self):
        self.log.info('\n')
    ...
    async def test_02_get_dataset_detail(self):
        self.log.info('\n')
        ...
        try:
            ...
            async with AsyncClient(app=self.app, base_url="http://test") as ac:
                headers = {'Authorization': 'Bearer ' + self.token}
                res = await ac.get(_test_api, headers=headers)
            self.log.info(f"RESPONSE: {res.text}")
            res_json = res.json()
            self.log.info(f"COMPARING CODE: {res_json.get('code')}, 200")
            self.assertEqual(res_json.get('code'), 200)
    ...
    async def test_03_get_dataset_detail_no_version(self):
        self.log.info('\n')
    ...
    async def test_04_get_dataset_detail_no_access(self):
        self.log.info('\n')
        ...
        try:
            ...
            self.log.error(f"ERROR 04: {e}")
            raise e

    async def test_05_get_dataset_detail_not_exist(self):
        self.log.info('\n')
