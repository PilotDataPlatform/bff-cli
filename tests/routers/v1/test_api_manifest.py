...
#     httpx_mock.add_response(
#         method='GET',
#         url=f'http://metadata_service/v1/item/search/?container_code={project_code}&container_type=project&parent_path=testuser&recursive=false&zone=zone&archived=false&name=fake_folder',
#         json={"code":200,"result": [{ 
#                 "id": "item-id", 
#                 "parent": "parent-id", 
